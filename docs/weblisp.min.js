"use strict";var weblisp=(()=>{var w=Object.defineProperty;var L=Object.getOwnPropertyDescriptor;var g=Object.getOwnPropertyNames;var b=Object.prototype.hasOwnProperty;var O=(h,t)=>{for(var s in t)w(h,s,{get:t[s],enumerable:!0})},S=(h,t,s,a)=>{if(t&&typeof t=="object"||typeof t=="function")for(let e of g(t))!b.call(h,e)&&e!==s&&w(h,e,{get:()=>t[e],enumerable:!(a=L(t,e))||a.enumerable});return h};var A=h=>S(w({},"__esModule",{value:!0}),h);var v={};O(v,{RunError:()=>d,WebLISP:()=>R});var N=class{constructor(t){this.src="";this.len=0;this.pos=0;this.token="";this.tokenRow=0;this.tokenCol=0;this.row=1;this.col=1;this.eof=!1;this.src=t,this.len=t.length,this.next()}getToken(){return this.token}getRow(){return this.tokenRow}getCol(){return this.tokenCol}isEof(){return this.eof}next(){let t=!1,s=!1;for(;;){if(s=!1,this.pos>=this.len){this.eof=!0;return}let a=this.src[this.pos];switch(a){case" ":case"	":this.pos++,this.col+=a=="	"?4:1;break;case`
